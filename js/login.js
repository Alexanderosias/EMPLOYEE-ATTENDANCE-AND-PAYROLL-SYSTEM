  ...
  loginForm.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      if (result.status === "success") {
        if (result.action === "select_role") {
          // Show role selection modal
          const roleModal = document.getElementById("roleModal");
          const loginAsEmployee = document.getElementById("loginAsEmployee");
          const loginAsAdmin = document.getElementById("loginAsAdmin");

          roleModal.classList.add("show");
          showMessage("Login successful. Please select a role.", false);

          loginAsEmployee.onclick = () => {
            window.location.href = "employee-pages/employee_dashboard.php";
          };
